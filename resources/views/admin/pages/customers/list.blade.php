                    ...
                    <div class="card-header border-bottom p-1">
                        ...
                        {{-- <div class="dt-action-buttons text-end">
                            <div class="dt-buttons d-inline-flex">
                                <a class="dt-button create-new btn btn-primary" href="{{route('customers.create')}}" tabindex="0"  type="button" >
                        ...
                        <table class="datatables-basic table table-hover  w-100 text-nowrap table-striped" id="customers-table">
...
@section('vendor-script')
  ...
  <script>
    ...
    getajaxdata('{{ route("customers.index") }}','customer');
