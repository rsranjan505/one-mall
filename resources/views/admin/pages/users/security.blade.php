        ...
        @if (isset($user))
            ...
            <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                ...
                <ul class="nav nav-pills mb-2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('users.security', $user->id)}}">
                ...
                <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-50">Change Password</h4>
                </div>
                <div class="card-body">
                    <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false">
                        ...
                        <input
                            ...
                            data-msg="Please enter current password"
                        />
                        </div>
                        <div class="col-12 col-md-12">
                        ...
                        <input
                            ...
                            data-msg="Please enter confirm password"
                        />
                        </div>
