        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="role-add-form" action="{{ route('roles.store') }}" data-table="role"  method="POST" enctype="multipart/form-data" >
                        @csrf
                        <div class="row">
                            <div class="mb-3">
                                <label class="form-label" for="mobile">Role Name</label>
                                <input type="text" id="name" name="name" placeholder="Role Name" class="form-control phone-mask @error('name') is-invalid @enderror" placeholder="Name" />
                                @error('name')
                                        ...
                                        @if ($old == $key)
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-check form-switch mb-2">
                                                    ...
                                                    <label><input type="checkbox" class="form-check-input" name="permission[]" value="{{ $value->name }}">{{ ucfirst($value->name) }}</label>
                                                </div>
                                            </div>
                                        @else
                                        @php
