...
<div class="page-content">
    <div class="container">
        {{-- @dump($product->attribute_value->where(['attribute_type' => 'varient'])) --}}
        @if (isset($product))
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="product-details">
                            <h1 class="product-title">{{ ucfirst($product->name) }}</h1><!-- End .product-title -->
                            ...
                            @if (isset($product->attributes))
                                ...
                                @foreach ($product->attributes as $attr_key => $item)

                                        <div class="details-filter-row details-row-size">
                                            <label>{{ ucfirst($attr_key)}}:</label>
                                            ...
                                            {{-- @elseif ($item->attribute->type == 'input') --}}
                                                {{-- <div class="product-nav product-nav-thumbs">
                                                    <a href="#" class="active">
                                                        <img src="{{ asset('marketplace/assets/images/products/single/1-thumb.jpg')}}" alt="product desc">
                                                    </a>
                                                    <a href="#">
                                                        <img src="{{asset('marketplace/assets/images/products/single/2-thumb.jpg')}}" alt="product desc">
                                                    </a>
                                                </div> --}}
                                            {{-- @endif --}}
                                        </div>
                            ...
                            <div class="details-filter-row details-row-size">
                                ...
                                <div class="product-details-quantity">
                                    <input type="number"  id="quantity-{{$product->id}}" name="quantity" class="form-control" value="{{$carts->where('product_id',$product->id)->count() > 0 ? $carts->where('product_id',$product->id)->first()->quantity : 0}}" class="form-control" value="1" min="1" max="10" step="1" data-decimals="0" required>
                                </div>
                            </div>

                            <div class="product-details-action">
                                <a href="javascript:void(0)" class="btn-product btn-cart" onclick="addTocart('{{$product->id}}','quantity-{{$product->id}}')"><span>add to cart</span></a>
