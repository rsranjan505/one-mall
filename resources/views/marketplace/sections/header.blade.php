                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="{{ asset('marketplace/assets/images/products/cart/product-2.jpg')}}" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html" class="banner banner-menu">
                                                            <img src="{{ asset('marketplace/assets/images/demos/demo-13/menu/banner-1.jpg')}}" alt="Banner">
                                                        </a>
                                        ...
                                        <div class="megamenu">
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html" class="banner banner-menu">
                                                            <img src="marketplace/assets/images/demos/demo-13/menu/banner-2.jpg" alt="Banner">
                                                        </a>
                                                    </div><!-- End .banner banner-overlay -->
                                                </div><!-- End .col-md-4 -->
                                            </div><!-- End .row -->
                                            ...
                                            <div class="menu-col">
                                                ...
                                                <div class="row menu-banners">
                                                    <div class="col-md-4">
                                                        <div class="banner">
                                                            <a href="#">
                                                                <img src="marketplace/assets/images/demos/demo-13/menu/1.jpg" alt="image">
                                                            </a>
                                                        </div><!-- End .banner -->
                                                    </div><!-- End .col-md-4 -->
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="banner">
                                                            <a href="#">
                                                                <img src="marketplace/assets/images/demos/demo-13/menu/2.jpg" alt="image">
                                                            </a>
                                                        </div><!-- End .banner -->
                                                    </div><!-- End .col-md-4 -->
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="banner">
                                                            <a href="#">
                                                                <img src="marketplace/assets/images/demos/demo-13/menu/3.jpg" alt="image">
                                                            </a>
                                                        </div><!-- End .banner -->
                                                    </div><!-- End .col-md-4 -->
                                                </div><!-- End .row -->
                                        ...
                                        <div class="megamenu">
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html" class="banner banner-menu">
                                                            <img src="marketplace/assets/images/demos/demo-13/menu/banner-3.jpg" alt="Banner">
                                                        </a>
                                                    </div><!-- End .banner banner-overlay -->
                                                </div><!-- End .col-md-4 -->
                                            </div><!-- End .row -->
                ...
                <div class="header-center">
                    <nav class="main-nav">
                        <ul class="menu sf-arrows">
                            ...
                            {{-- <li class="">
                                <a href="{{ route('market.home')}}" class="">Contact</a>
                            </li> --}}
